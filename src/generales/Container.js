...
function Container({ styleContainer, children, isloading = false, footer = true }) {
	return (
				...
				<Item
					...
					icon={
						<SvgHome
							...
							color={routeName === 'Products' ? colores.amarillo : colores.bgOscuro}
						/>
					}
				/>
			</View>
				...
				<Item
					...
					icon={
						<SvgProfile
							height={screenWidth <= 360 ? '30%' : '40%'}
							width={screenWidth <= 360 ? '30%' : '40%'}
							color={routeName === 'MyAccount' ? colores.amarillo : colores.bgOscuro}
						/>
					}
				/>
			</View>
				...
				<Item
					...
					icon={
						<SvgOrders
							height={screenWidth <= 360 ? '30%' : '40%'}
							width={screenWidth <= 360 ? '30%' : '40%'}
							color={routeName === 'MisPedidos' ? colores.amarillo : colores.bgOscuro}
						/>
					}
				/>
			</View>
				...
				<Item
					...
					icon={
						<CardIcon
							height={screenWidth <= 360 ? '30%' : '40%'}
							width={screenWidth <= 360 ? '30%' : '40%'}
							color={routeName === 'Tarjetas' ? colores.amarillo : colores.bgOscuro}
						/>
					}
				/>
			</View>
				...
				<Item
					...
					icon={
						<SvgLogout
							height={screenWidth <= 360 ? '30%' : '40%'}
							width={screenWidth <= 360 ? '30%' : '40%'}
							color={routeName === 'Logout' ? colores.amarillo : colores.bgOscuro}
						/>
					}
				/>
			</View>
	...
	return (
		<TouchableOpacity
			onPress={() => {
				...
				if (ruta === 'Products' || ruta === 'MyAccount' || ruta === 'MisPedidos' || ruta === 'Tarjetas') {
